...
function upgradeEquipment(player, equipmentType, event) {
  ...
  let attributeModifiers = itemMeta.getAttributeModifiers(org.bukkit.attribute.Attribute.GENERIC_MAX_HEALTH);
  decrementItemAmount(event.getItem());
  if (attributeModifiers == null || attributeModifiers.isEmpty()) {
    addArmorAttribute(itemMeta, equipmentType);
    player.sendMessage("强化成功！装备生命值已增加。");
  } else {
